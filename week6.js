...
let alpabet = alphabetString.split("");
console.log(alpabet);
...
// alphabet array from z to a//
let alpabetreverse = alphabetArray.reverse("");

console.log(alpabetreverse);

// elements of array to string & print console//
...
console.log("step4:");
let array = array1.push(16, 3);
console.log(array1);

console.log("step5: ", array1[2]);

console.log("step6: ", array1[array1.length - 1]);
...
console.log("step2: ");
let todoItems = myTodoList.push("clean", "laundry", "cook");
console.log(myTodoList);

console.log("step3: ", myTodoList.splice(2, 1));
console.log(myTodoList);

console.log("step4: ");
let yourTodoList = ["assignements", "washhair"];
